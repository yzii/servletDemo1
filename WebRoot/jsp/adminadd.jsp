...
<html>
  ...
  <body>
	<form action="servlet/Admin_AddServlet" method="post" onsubmit="return checkForm()">
		<div id="container">
	   	 <div id="right">
	    	<div class="content">
	       	  <div class="rtbd">
	        	...
	        	<table class="tblist" width="100%" cellspacing="0" cellpadding="0">                       
	              <tr>
	                <td align="right">管理员：<input type="text" name="admin_Name" id="admin_Name"/></td>
	                <td align="left">&nbsp;密码：<input type="password" style="width: 155px;" name="admin_Pwd" id="admin_Pwd"></td>
